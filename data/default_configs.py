...
GAME_CONFIG = {
    "combat": {
        ...
        "comment": "战斗判定参数（概率上限、行动/状态叠加上限、护甲公式）。护甲公式：减伤率=护甲/(护甲+K)，K=armor_k_base+armor_k_level_coeff*等级；remaining_hp_mid_threshold/remaining_hp_low_threshold 为战报剩余气血行分档阈值（合法域 0<low<mid<1，非法值回退代码默认 0.3/0.6）",
        "status_stack_cap": 3,
