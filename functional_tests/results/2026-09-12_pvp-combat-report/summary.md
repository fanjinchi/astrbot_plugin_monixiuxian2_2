# 功能测试结果：2026-09-12_pvp-combat-report

- 导出时间：2026-09-12T19:37:41
- 运行记录数：24
- 通过：24
- 失败/错误：0
- 不稳定：0
...
- pvp-basic-duel: round_header= 190, dodge_prose= 20（采样 1 次，最长回合=19）
- pvp-basic-spar: round_header= 6（采样 1 次，最长回合=1）
