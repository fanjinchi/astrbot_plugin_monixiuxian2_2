...
| `world-bible.md` | 本项目 | **世界观设定集（World Bible）**（2026-08-24 建立，openspec change `worldview-bible`；2026-08-26 设定修订：六州山河州域正式化、秘境示例化、五宗规划+合欢宗延后、心法文风按宗门形象分档、废除体修短寿叙事；2026-09-03 叙事内容管线增补：§6 全枚举退役迁 canon 表、§1.3b 擦边尺度、§1.6 文案载体清单、§1.7 变体量标准、§3.2.6 NPC 三件套、§3.6 势力冲突矩阵）：摸鱼修仙界主线性（灵气枯竭→复苏）、基调与玩梗/擦边尺度、地理（六州山河+妖域四层）、势力（五宗规划+合欢宗延后+冲突矩阵）、修炼体系叙事化（灵/体双词汇表）、命名规范（品级词+禁用词）、既有内容收编清单（全枚举已迁 canon 表）。**全部内容文案的唯一事实来源**。世界观/文案基调变更时须同步本文。 |
